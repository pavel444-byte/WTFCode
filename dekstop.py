...
class WTFCodeDesktop(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        self.provider_menu = ctk.CTkOptionMenu(self.sidebar, values=["openai", "anthropic", "gemini", "llama", "azure_openai"], variable=self.provider_var, command=self.update_assistant)
