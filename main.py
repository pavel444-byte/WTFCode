...
class CodeAssist:
    ...
    def add_context_image(self, path: str) -> str:
        ...
        return f"Added image to context for the next message: {image_path}"

    def remove_context_image(self, target: str) -> str:
        """Remove a pending image by path or 1-based list index."""
    ...
    def list_context_images(self) -> str:
        ...
        if not self.context_images:
            return "No images are currently attached to context."
        lines = ["Images attached to the next message:"]
        ...
        try:
            ...
            if query == '/help':
                ...
                console.print(Panel(
                    ...
                    "[bold cyan]/context image {list|add|remove}[/bold cyan] - Manage next-message image attachments\n"
